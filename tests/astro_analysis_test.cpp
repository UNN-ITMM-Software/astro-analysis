...
TEST(astrocyte_test, check_normalization_of_source_video)
{
	...
	ASSERT_EQ(preprocessed_video.cell(0, 0, 0), lb);
	ASSERT_EQ(preprocessed_video.cell(0, 0, 1), rb);
}

TEST(astrocyte_test, check_smoothing_of_source_video)
{
...
TEST(astrocyte_test, check_set_component_indeces)
{
	...
	ASSERT_EQ(ds.find_set(0), ds.find_set(3));
	ASSERT_EQ(ds.find_set(0), ds.find_set(10));
	...
	ASSERT_EQ(ds.find_set(2), ds.find_set(4));
	ASSERT_EQ(ds.find_set(2), ds.find_set(9));
	ASSERT_EQ(ds.find_set(2), ds.find_set(12));
	ASSERT_EQ(ds.find_set(2), ds.find_set(13));
}
